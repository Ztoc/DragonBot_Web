    ...
    return (
        <div className='page-bg'>
            ...
            <div className='apps-container h-screen flex flex-col items-center justify-center'>
                <AppSlider />
                <div className='apps-buttons-container w-full px-12'>
                    ...
                    <div className='block flex items-center justify-between'>
                        <div className='blur-round-border-bg p-2' style={{
                            ...
                            <img className='icon-x-img w-[70px] h-[70px]' src='../public/icon/defaults/twitter.png'/>
                        </div>
                        <div className='blur-round-border-bg p-2' style={{
                            '--radius': '13px',
                            '--angle': '135deg',
                            ...
                            <img className='icon-m-img w-[70px] h-[70px]' src='../public/icon/defaults/medium.png'/>
                        </div>
                        <div className='blur-round-border-bg p-2' style={{
                            '--radius': '13px',
                            '--angle': '135deg',
                            ...
                            <img className='icon-t-img w-[70px] h-[70px]' src='../public/icon/defaults/telegram.png'/>
                        </div>
                    </div>
                </div>
            </div>
