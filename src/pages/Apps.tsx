                ...
                <div className='apps-buttons-container w-full px-[9%]'>
                    ...
                    <div className='block flex items-center justify-around'>
                        <div className='blur-round-border-bg p-2' style={{
                            ...
                            <img className='icon-x-img w-[60px] h-[60px]' src={twitterIMG?.src}/>
                        </div>
                        <div className='blur-round-border-bg p-2' style={{
                            '--radius': '13px',
                            '--angle': '135deg',
                            ...
                            <img className='icon-m-img w-[60px] h-[60px]' src={mediumImg?.src}/>
                        </div>
                        <div className='blur-round-border-bg p-2' style={{
                            '--radius': '13px',
                            '--angle': '135deg',
                            ...
                            <img className='icon-t-img w-[60px] h-[60px]' src={telegramImg?.src}/>
                        </div>
                    </div>
                </div>
            </div>
