...
// import HISTORY_IMG from "/icon/defaults/hostory.png";
...
import BRONZE_MEDAL from "/icon/medals/bronze.png";
import SILVER_MEDAL from "/icon/medals/silver.png";
import GOLD_MEDAL from "/icon/medals/gold.png";
...
import DRAGON1 from "/icon/dragon/dragon1.png";
import DRAGON3 from "/icon/dragon/dragon3.png";
import DRAGON4 from "/icon/dragon/dragon4.png";
      ...
      im.onload = () => {
        if (img.type == "booster") {
          ...
          if (
            store
              .getState()
              .image.booster.filter(
                (x) =>
                  x.name === "RECHARGING_SPEED" ||
                  x.name === "MULTI_TAP" ||
                  x.name == "AUTO_TAP_BOT" ||
                  x.name == "ENERGY_LIMIT"
              ).length >= 4
          ...
          if (
            store.getState().image.dailyBooster.filter((x) => x.name === "TURBO" || x.name === "ENERGY").length >= 2
          ) {
          ...
          if (
            store
              .getState()
              .image.skin.filter(
                (x) => x.name === "BASIC" || x.name === "BITCOIN" || x.name == "VOTE_PEDRO" || x.name == "JADE_COIN"
              ).length >= 4
          ) {
        ...
        store
          ...
          .image.core.filter(
            (x) =>
              ...
              x.name == "CLOSE_ICON" ||
              x.name == "ENTER_BG" ||
              x.name == "WELCOME_HEADER" ||
              x.name == "DRAGON_TAP" ||
              x.name == "DRAGON_WAR" ||
              x.name == "DRAGON_LAUNCHPADS" ||
              x.name == "DRAGON_MINT" ||
              x.name == "DRAGON_CATCH" ||
              x.name == "TWITTER" ||
              x.name == "MEDIUM" ||
              x.name == "TELEGRAM" ||
              x.name == "AUTO_EARN_BOT" ||
              x.name == "APP_BACKGROUND"
          ).length >= 18
      ) {
...
export const loadDragonImages = () => {
  const loadImages = [
    { name: "BRONZE_MEDAL", src: BRONZE_MEDAL },
    { name: "SILVER_MEDAL", src: SILVER_MEDAL },
    { name: "GOLD_MEDAL", src: GOLD_MEDAL },
    { name: "SILVER_LARGE_MEDAL", src: SILVER_LARGE_MEDAL },
    { name: "SILVER_EXTRALARGE_MEDAL", src: SILVER_EXTRALARGE_MEDAL },
    { name: "OPTION_ICON", src: OPTION_ICON },
    { name: "HISTORY_ICON", src: HISTORY_ICON },
    { name: "POT1", src: POT },
    { name: "POT3", src: POT3 },
    { name: "POT4", src: POT4 },
    { name: "CUP_ICON", src: CUP },
    { name: "DRAGON1", src: DRAGON1 },
    { name: "DRAGON3", src: DRAGON3 },
    { name: "DRAGON4", src: DRAGON4 },
    { name: "DRAGON5", src: DRAGON5 },
    { name: "DRAGON6", src: DRAGON6 },
    { name: "TON_ICON", src: TON_ICON },
    // { name: "APP_BACKGROUND", src: APP_BACKGROUND_IMG },
  ];
  return loadImages.forEach((img) => {
    const im = new Image();
    ...
    im.onload = () => {
      ...
      if (
        store
          ...
          .image.dragon.filter(
            (x) =>
              ...
              x.name == "SILVER_MEDAL" ||
              x.name == "GOLD_MEDAL" ||
              x.name == "SILVER_LARGE_MEDAL" ||
              x.name == "SILVER_EXTRALARGE_MEDAL" ||
              x.name == "CLOSE_ICON" ||
              x.name == "ENTER_BG" ||
              x.name == "WELCOME_HEADER" ||
              x.name == "DRAGON_TAP" ||
        ...
        store.dispatch(setDragonDone(true));
      }
    };
  });
};
    ...
    small_image.onload = () => {
      ...
      if (
        store
          ...
          .image.league.filter(
            (x) =>
              x.name === "BRONZE_LEAGUE" ||
              x.name === "SILVER_LEAGUE" ||
              x.name === "GOLD_LEAGUE" ||
              x.name === "PLATINUM_LEAGUE" ||
              x.name === "EMERALD_LEAGUE" ||
              x.name === "RUBY_LEAGUE" ||
              x.name === "DIAMOND_LEAGUE" ||
              x.name === "LOONG_LEAGUE"
          ).length >= 8
      ) {
  ...
  return loadImages.forEach((img) => {
    ...
    im.onload = () => {
      ...
      if (
        store
          .getState()
          .image.optional.filter(
            (x) =>
              x.name == "JOIN_SQUAD_BG" ||
              x.name == "TOP_FRENS_BG" ||
              x.name == "SQUAD_DETAIL_BG" ||
              x.name == "OPEN_ARROW" ||
              x.name == "LEFT_ARROW" ||
              x.name == "RIGHT_ARROW" ||
              x.name == "TG_PREMIUM" ||
